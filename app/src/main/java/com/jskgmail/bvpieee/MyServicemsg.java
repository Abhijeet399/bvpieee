...
public class MyServicemsg extends Service {
    ...
    private void sendNotification() {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentTitle("Discussion Forum @BVPIEEE")
                        .setContentText("Few unread messages in the Discussion Forum")
                        .setAutoCancel(true)
